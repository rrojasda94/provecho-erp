...
|---|---|---|---|---|
| PROC-CMP-001 | Compras | v2.0 | Vigente | [workflows.md](workflows.md#compras); v2.0 introduce los 3 caminos de compra (informal/caja chica, preferente sin cotización, estándar/activo con RFQ) y traslada la ejecución del pago a Contabilidad — cambio de resultado y actores (MAYOR). **BPMN 2026-08-05**: [PROC-CMP-001-v2.0.bpmn](../diagrams/Procesos/Compras/PROC-CMP-001-v2.0.bpmn) |
...
| PROC-INV-001 | Abastecimiento de locales | v0.2 | Vigente | [workflows.md](workflows.md#abastecimiento-de-locales); v0.2 detalla el conteo de fin de jornada en sucursal (balanzas, QR, ventana de refrigeración, alerta por margen de error RN-INV-015, cálculo de sugerido RN-INV-013); picking/packing/transporte en almacén central sigue sin este nivel de detalle. **BPMN 2026-08-05**: [PROC-INV-001-v0.2.bpmn](../diagrams/Procesos/Logistica-Almacen/PROC-INV-001-v0.2.bpmn) — pasa a Vigente porque el ciclo completo está implementado (ADR-020) y el traslado ya emite guía (ADR-027) |
| PROC-COM-001 | Venta | v1.0 | Vigente | [workflows.md](workflows.md#venta), decisión de alcance 2026-07-14 |
| PROC-GER-001 | Definición del presupuesto anual | v1.0 | Borrador | [workflows.md](workflows.md#definición-del-presupuesto-anual); reunión anual donde cada área presenta propuesta y Gerencia designa presupuesto + límite de gasto autónomo (RN-GER-007); límites por área aún `[[ COMPLETAR ]]` |
| PROC-MKT-001 | Campaña de marketing | v1.0 | Borrador | [workflows.md](workflows.md#campaña-de-marketing); v1.0 (2026-07-22): spec completa (brief con objetivo/KPI, aprobación gerencial sobre umbral, naming/uso de marca, material vía Compras con verificación en sucursal, atribución lead→venta con Comercial) — Borrador porque el área Marketing recién se documenta, ver [docs/marketing/README.md](../marketing/README.md) |
...
| PROC-RRH-001 | Incorporación de personal | v1.0 | Vigente | [BPMN](../diagrams/Procesos/Recursos-Humanos/PROC-RRH-001-v1.0.bpmn) + los 13 SOPs de [docs/rrhh/](../rrhh/README.md); cubre requisición → convocatoria → entrevista → oferta → contrato y alta en T-Registro → inducción → evaluaciones de mes 1 y 2.5. Parcialmente implementado: convocatoria y tablero de contratación en código (2026-08-01); entrevista, inducción y periodo de prueba especificados en `data-model.md §8b` (2026-08-05), sin tabla todavía |
| PROC-RRH-002 | Contingencia de personal faltante en la apertura | v1.0 | Vigente | [BPMN](../diagrams/Procesos/Recursos-Humanos/PROC-RRH-002-v1.0.bpmn); RN-RRHH-011. El local **abre igual**: el personal presente cubre lo crítico mientras se busca reemplazo. El pago extra del reemplazo se le descuenta al faltante salvo constancia médica. Sin soporte en código |
| PROC-RRH-003 | Tardanza o falta del encargado a la apertura | v1.0 | Vigente | [BPMN](../diagrams/Procesos/Recursos-Humanos/PROC-RRH-003-v1.0.bpmn); RN-RRHH-010. Gradualidad: hasta 30 min es memorándum y **no es sanción**; más de 30 min o falta es carta de amonestación (RN-RRHH-004). Con aviso de 24 h o coordinación previa no se dispara. Sin soporte en código |
| PROC-COM-003 | Definición y revisión de precio | v1.0 | Vigente | [BPMN](../diagrams/Procesos/Comercial/PROC-COM-003-v1.0.bpmn) + [SOP](../diagrams/Procesos/Comercial/Precios-Promociones/evaluacion-precio-margen-contribucion.md); RN-PRC-001/002/003/005. El precio nunca se edita en el POS: sale de la lista vigente. Bajo el margen mínimo exige aprobación de Gerencia con sustento escrito |
