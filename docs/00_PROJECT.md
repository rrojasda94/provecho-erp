...
| | [bi-superset.md](engineering/bi-superset.md) | Runbook del droplet del BI autoservicio (ADR-082): aprovisionar Postgres/Superset, bugs encontrados al ensayarlo |
