...
- **Relacionado:** ADR-005 (integraciones que prellenan), ADR-009 (hub
  ...
  elige en el mapa)
- **Superado en parte por ADR-067** (2026-08-25): la tarifa ya **no sale del
...
> **ADR-067:** esos tres valores pasaron a ser la **semilla**. La tarifa que
...
- **Sumar el reparto al total de la venta.** Es lo que corresponde a futuro,
  ...
  **Resuelto por ADR-067 (2026-08-25)**, y sin la línea de venta: el flete
...
- **Tarifa por sucursal o por marca.** Arranca global en `settings`. Cuando
  ...
  Con ADR-067 pasó a ser **por empresa** (`parametro_empresa`); por sucursal
  sigue diferida.
