# ADR-064 — El pad de asistencia se abre con la cuenta del local, y las pantallas las monta la administración
...
- Relacionado: ADR-013 (pantallas fuera del shell), ADR-045/ADR-050 (pinpad),
  ...
  ADR-063 (turno de trabajo), RN-AUD-005, RN-PER-002, RN-RRHH-020,
...
el turno vigente, ADR-063) y `horas_extra = 0` siempre.
