# ADR-063 — El turno de trabajo es una entidad, y la hora límite vive en él
...
- Relacionado: ADR-014 (parámetros configurables por empresa), ADR-062 (centro
  de labores), ADR-064 (pad de asistencia), RN-RRHH-009 (no marcado no se
...
- El aviso de salida sin marcar (`rrhh.salida_sin_marcar`) tiene por fin una
  hora contra la cual estar vencido — ver ADR-064.
