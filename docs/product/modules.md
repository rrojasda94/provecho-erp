...
| delivery | [src/modules/delivery/README.md](../../src/modules/delivery/README.md) | Slices 2-4 implementados 2026-09-09 (ADR-098): repartidores, tablero, ciclo de ruta/entrega con ruteo real u heurístico, GPS, seguimiento público con mapa y PWA instalable del repartidor. Falta el tablero del ERP y avisos |
