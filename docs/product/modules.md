...
| delivery | [src/modules/delivery/README.md](../../src/modules/delivery/README.md) | Slices 2-5 implementados 2026-09-09 (ADR-098): repartidores, ciclo de ruta/entrega con ruteo real u heurístico, GPS, seguimiento público con mapa, PWA instalable del repartidor y tablero de despacho en el ERP. Falta el aviso por WhatsApp |
