...
| `delivery` (reparto propio: repartidores, rutas, seguimiento público) | 🔶 En curso | Slice core implementado 2026-09-09 (ADR-098): repartidores, tablero de despacho y ciclo completo de ruta/entrega con ruteo heurístico, convergiendo con `sales` por evento en los dos sentidos. Falta ruteo real contra Google Routes, GPS de flota, enlace público de seguimiento y aviso automático por WhatsApp. | [`modulo-delivery.md`](docs/roadmap/historial/modulo-delivery.md) |
