...
- ⬜ **`parametro_empresa`** (ADR-014, `data-model.md` §8c, RN-GER-008):
  ...
  lista** (ADR-017, 2026-08-01): es por categoría, no por empresa, y vive
...
- ⬜ **Contrato de lectura `purchases` ↔ `inventory.solicitud_insumos`**
  ...
  2026-08-01 — `solicitud_insumos` ya existe en código (ADR-018). Falta
...
- ✅ 2026-08-01 **`reserva_stock` + `solicitud_insumos` + transferencias**
  (ADR-018, migración `d8b35f1ca207`): ciclo completo local pide →
...
- ✅ 2026-08-01 **Conteo cíclico** (ADR-017, migración `c4e70a91d5b8`):
