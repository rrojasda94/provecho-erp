...
| Frontend (F2 — arquitectura y UX, documento 2026-07-27, actualizado tras ADR-013) | [`frontend.md`](docs/roadmap/deuda/frontend.md) | 29 | 25 |
| Módulo storefront (sitio de marca, PR1 — deuda declarada) | [`modulo-storefront.md`](docs/roadmap/deuda/modulo-storefront.md) | 8 | 1 |
