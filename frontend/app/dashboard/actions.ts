...
export async function logoutAction() {
  ...
  if (refresh) {
    try {
      // Revoca la sesión en el servidor. Logout es idempotente (backend) y
      // un fallo de red acá no debe impedir borrar la cookie local: el
      // usuario tiene que poder salir aunque la API esté caída.
