- **El plan de cuentas de fábrica es el PCGE** (2026-08-29, ADR-080). El
...
- **Los asientos automáticos son los asientos peruanos completos** (ADR-080).
...
- **Estados financieros** (ADR-080): balance de comprobación, libro mayor,
...
- **Un asiento ya no se imputa contra un rubro que agrupa a otras cuentas**
  (ADR-080). Cargar contra «42 Cuentas por pagar comerciales» dejaba el mayor
