...
- Descuento manual de orden en `venta` (`descuento_modo`,
  ...
  (ADR-023, 2026-08-02)**: si `permiso.restricciones` trae `monto_maximo`
...
- **Restas** (RN-COM-028): `venta_item.sin_articulo_ids` (JSONB, nullable)
  ...
  las restas y `inventory` salta ese insumo (RN-PRD-019). La reposición por
...
es de administración desde 2026-08-24** (ADR-064): montar, renombrar o borrar
